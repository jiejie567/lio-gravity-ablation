...
public:
    ...
    mapOptimization()
    {
        ...
        bool useQrFactorization = false;
        nh.param<bool>("lio_sam/useQrFactorization", useQrFactorization, false);
        ...
        int mappingInputQueueSize = 1;
        nh.param<int>("lio_sam/mappingInputQueueSize", mappingInputQueueSize, 1);
        subCloud = nh.subscribe<lio_sam::cloud_info>("lio_sam/feature/cloud_info", mappingInputQueueSize, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
